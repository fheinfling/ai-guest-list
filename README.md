...
2. Unzip, drag **AI Guest List.app** to `/Applications`.
3. It's **unsigned** (no Apple Developer cert yet), so on first open: **right-click → Open → Open**, or
   `xattr -dr com.apple.quarantine "/Applications/AI Guest List.app"`.
4. Launch it, click the menubar door, and **add your seats**.
